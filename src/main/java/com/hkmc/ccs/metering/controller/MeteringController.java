  ...
  public ResponseEntity<MeteringCheckResponse> checkAPIAccess(@RequestBody MeteringCheckRequest request,
    ...
    try {
      ...
      if (ObjectUtils.isEmpty(request.getServiceNo()) ||
        ...
        LOGGER.warn("[XTID : {}] 미터링 ValidationCheck 전문형식오류 서비스ID[{}] carID[{}] CCID[{}] requestURL[{}]", xTid,
...
//      }
      ...
      LOGGER.warn("[XTID : {}] CCSP 미터링 Controller EXCEPTION 발생, serviceNo[{}], CCID[{}], CARID[{}] ,EXCEPTION : {}",
